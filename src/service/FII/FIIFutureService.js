...
const csvFilePath = path.join(__dirname, '../../constants/FII/FIIFUTUREDATA .csv');
import { RootRepository } from '../RootRepository';
import { FIIFutureModel } from '../../db/models'
...
class FIIFutureService extends RootRepository {
  ...
  //   const newData = convertArrayToFIIModelFormat(results.data);
  //   try {
  //     const result = await RootRepository.insertMany(newData, FIIFutureModel);
  //     if(result) {
