...
const csvFilePath = path.join(__dirname, '../../constants/FII/FIIPUTDATA.csv');
import { RootRepository } from '../RootRepository';
import { FIIPutModel } from '../../db/models'
...
class FIIPutService extends RootRepository {
  ...
  //   try {
  //     const result = await RootRepository.insertMany(newData, FIIPutModel);
  //     if(result) {
