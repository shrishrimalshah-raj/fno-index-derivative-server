...
import { CLIENTCallModel } from "../../../../db/models";
...
class CLIENTCallService extends RootRepository{
  constructor(model) {
    super(model);
  }

  async insertDataForClientCall(data, date) {
...
export default new CLIENTCallService(CLIENTCallModel);