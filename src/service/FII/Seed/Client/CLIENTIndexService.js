...
import { CLIENTIndexModel } from "../../../../db/models";
import {
  CreateRecord,
...
class CLIENTIndexService extends RootRepository{
  constructor(model) {
    super(model);
  }

  async insertDataForClientIndex(data, date) {
...
export default new CLIENTIndexService(CLIENTIndexModel);